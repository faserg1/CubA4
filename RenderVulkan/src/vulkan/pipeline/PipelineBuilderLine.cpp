...
PipelineBuilderLine::PipelineBuilderLine(std::shared_ptr<const Device> device, CubA4::render::config::VulkanConfigAdapter config) :
	PipelineBuilderBase(device, config)
{
}

PipelineBuilderLine::~PipelineBuilderLine()
{
...
void PipelineBuilderLine::prepareInputAssembly()
{
	inputAssemblyInfo_.topology = VK_PRIMITIVE_TOPOLOGY_LINE_LIST;
}

void PipelineBuilderLine::prepareRasterization()
{
...
void PipelineBuilderLine::prepareMultisampling()
{
	multisampleInfo_.rasterizationSamples = VK_SAMPLE_COUNT_1_BIT;
}

void PipelineBuilderLine::prepareDepthStencil()
{
...
void PipelineBuilderLine::prepareColorBlending()
{
...
void PipelineBuilderLine::prepareDynmaic()
{
...
void PipelineBuilderLine::prepareViewport()
{
	viewportStateInfo_.viewportCount = 1;
	viewportStateInfo_.scissorCount = 1;
}

void PipelineBuilderLine::prepareDescriptorSets()
{
}

void PipelineBuilderLine::preparePushConstants()
{
