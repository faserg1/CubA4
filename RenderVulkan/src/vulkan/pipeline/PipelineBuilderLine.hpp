...
namespace CubA4::render
{
	...
	namespace vulkan
	{
		...
		class PipelineBuilderLine : public PipelineBuilderBase
		{
		public:
			explicit PipelineBuilderLine(std::shared_ptr<const Device> device, CubA4::render::config::VulkanConfigAdapter config);
			~PipelineBuilderLine();
