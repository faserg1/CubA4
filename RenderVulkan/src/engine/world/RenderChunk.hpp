	...
	namespace render
	{
		namespace engine
		{
			namespace world
			{
				...
				{
				public:
					explicit RenderChunk(const CubA4::core::world::ChunkPos &pos, std::vector<VkCommandBuffer> cmdBuffers, std::function<void()> deleter);
					~RenderChunk();

					void executeFrom(VkCommandBuffer primaryCmdBuffer) const;
					const CubA4::core::world::ChunkPos &getChunkPos() const;
				protected:
				private:
					const CubA4::core::world::ChunkPos pos_;
