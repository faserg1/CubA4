...
namespace CubA4
{
	...
	namespace render
	{
		...
		namespace engine
		{
			...
			{
			public:
				explicit RenderEngine(std::shared_ptr<const core::info::IApplicationInfo> info, std::shared_ptr<const core::ICore> core);
				explicit RenderEngine(const RenderEngine &) = delete;
				~RenderEngine();
