...
namespace CubA4::world
{
	...
	{
	public:
		explicit ChunkBMutable(size_t id, CubA4::core::IIdentityiMap::IdType blockId, CubA4::world::Layer layer);
		~ChunkBMutable();

		size_t getId() const override;
		bool isIndexGlobal() const override;
		CubA4::core::IIdentityiMap::IdType getBlockId() const override;
	...
	private:
		const size_t id_;
		CubA4::core::IIdentityiMap::IdType blockId_;
