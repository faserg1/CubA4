...
namespace CubA4::util
{
	...
	class ChunkPosHashT
	{
		static_assert(std::is_same<TKey, CubA4::world::ChunkPos>::value, "TKey must be ChunkPos");
	public:
		size_t operator()(const CubA4::world::ChunkPos &chunkPos) const
		{
	...
	using ChunkPosHash = ChunkPosHashT<CubA4::world::ChunkPos>;
}
