...
class ResourceGenerator:
	...
	def _generate_irs_cpp(self):
		...
		total += nstabs + "\tif (iter == info.end())\n"
		total += nstabs + "\t\treturn nullptr;\n"
		total += nstabs + "\tsize = iter->second.filesize;\n"
		total += nstabs + "\tptr += iter->second.offset;\n"
		total += nstabs + "\treturn ptr;\n"
		total += nstabs + "}\n"
		total += "\t}\n}\n\n"
