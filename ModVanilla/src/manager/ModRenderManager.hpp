	...
	namespace mod
	{
		namespace manager
		{
			...
			public:
				...
				std::shared_ptr<const CubA4::render::engine::material::ITexture> getTexture(const std::string &id) const override;
				...
				void registerTexture(std::shared_ptr<const CubA4::render::engine::material::ITexture> renderTexture, const std::string &id);
			protected:
			private:
				...
				std::map<std::string, std::shared_ptr<const CubA4::render::engine::material::ITexture>> textureMap_;
			};
		}
	}
}
